...
BLOG_AUTHOR = "Cambiar"  # (translatable)
BLOG_TITLE = "Cambiar"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://slcorvus.org/fisica/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://slcorvus.org/fisica/"
BLOG_EMAIL = "jsandoval@utp.edu.co"
BLOG_DESCRIPTION = "Cambiar la descripción"  # (translatable)
